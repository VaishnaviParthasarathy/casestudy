...
public class ProductBrand {
    ...
    public ProductBrand withBrand(String brand) {
        this.brand = brand;
        return this;
    }
    ...
    public ProductBrand withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProductBrand) == false) {
            return false;
        }
        ProductBrand rhs = ((ProductBrand) other);
